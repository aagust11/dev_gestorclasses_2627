...
export interface Subject {
  ...
  generalLinks?: { id: string; label: string; url: string; icon?: string; color?: string; shared?: boolean; image?: string; uicon?: string }[]; // Persistent links for general teaching actions
}
